import type { FetchOptions, ProgressStatus as XHRProgressStatus } from 'ipfs-utils/src/types';
import { Link, UnknownLink, Version } from 'multiformats/link';
import { Block } from '@ipld/unixfs';
import { CAR } from '@ucanto/transport';
import { ServiceMethod, ConnectionView, Signer, Proof, DID, Principal } from '@ucanto/interface';
import { StoreAdd, StoreList, StoreRemove, UploadAdd, UploadList, UploadRemove } from '@web3-storage/capabilities/types';
import * as UnixFS from '@ipld/unixfs/src/unixfs';
export type { FetchOptions, StoreAdd, StoreList, StoreRemove, UploadAdd, UploadList, UploadRemove, };
...
export type StoreAddResponse = StoreAddDoneResponse | StoreAddUploadRequiredResponse;
