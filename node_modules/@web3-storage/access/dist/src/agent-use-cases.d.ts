...
export function waitForAuthorizationOnSocket(accessAgent: AccessAgent, opts: AuthorizationWaiterOpts): Promise<Iterable<Ucanto.Delegation>>;
export function waitForAuthorizationByPolling(accessAgent: AccessAgent, opts: AuthorizationWaiterOpts): Promise<Iterable<Ucanto.Delegation>>;
/**
...
export type AuthorizationWaiterOpts = {
    signal?: AbortSignal;
};
export type AuthorizationWaiter = (accessAgent: AccessAgent, opts: AuthorizationWaiterOpts) => Promise<Iterable<Ucanto.Delegation>>;
