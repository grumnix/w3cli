...
export function intersection<T extends Schema.Reader<unknown, I, Schema.Error>, U extends [T, ...T[]], I = unknown>(variants: U): Schema.Schema<Schema.InferIntesection<U>, I>;
...
export function error(message: string): Schema.Error;
...
export { createEnum as enum, _enum as enum };
