...
export function derive<M extends API.Match<any, API.UnknownMatch>, T extends API.ParsedCapability<API.Ability, API.URI<`${string}:`>, any>>({ from, to, derives }: {
 ...
 */
declare class DerivedMatch<T extends API.ParsedCapability<API.Ability, API.URI<`${string}:`>, any>, M extends API.Match<any, API.UnknownMatch>> implements API.DerivedMatch<T, M> {
    /**
