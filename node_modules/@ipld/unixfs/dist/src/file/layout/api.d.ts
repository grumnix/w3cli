...
export declare type WriteResult<Layout> = {
    layout: Layout;
    nodes: Branch[];
    leaves: Leaf[];
};
...
export declare type Node = Leaf | Branch;
export declare type NodeID = ID<Node>;
export declare type ID<T> = PropertyKey & Phantom<T>;
export declare type FileChunkEncoder = BlockEncoder<PB, Uint8Array> | BlockEncoder<RAW, Uint8Array>;
export declare type PB = 0x70;
export declare type RAW = 0x55;
