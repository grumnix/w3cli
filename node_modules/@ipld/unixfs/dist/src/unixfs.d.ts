 ...
 */
export declare type Node = Raw | SimpleFile | AdvancedFile | ComplexFile | Directory | DirectoryShard | ShardedDirectory | Symlink;
export declare type File = SimpleFile | AdvancedFile | ComplexFile;
/**
...
export declare type Chunk = Raw | FileChunk;
/**
...
export declare type FileLink = ContentDAGLink<Uint8Array> | ContentDAGLink<Chunk> | ContentDAGLink<FileShard>;
 ...
 */
export declare type Directory = FlatDirectory | ShardedDirectory;
/**
...
export declare type DirectoryEntryLink = NamedDAGLink<File> | NamedDAGLink<Directory> | NamedDAGLink<Uint8Array>;
export declare type DirectoryLink = DAGLink<Directory>;
...
export declare type ShardedDirectoryLink = NamedDAGLink<File> | NamedDAGLink<Uint8Array> | NamedDAGLink<Directory> | NamedDAGLink<DirectoryShard>;
/**
 ...
 */
export declare type Mode = uint32;
/**
 * representing the modification time in seconds relative to the unix epoch
 * 1970-01-01T00:00:00Z.
 */
 ...
 */
export declare type Bitfield = Uint8Array;
